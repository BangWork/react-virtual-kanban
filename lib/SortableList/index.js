      ...
      return _react2.default.createElement(
        ...
        function (_ref3) {
          ...
          return _react2.default.createElement(_SortableItem2.default, {
            ...
            row: row,
            rowId: row.id,
            listId: _this3.props.listId,
            list: _this3.props.list,
            rowStyle: style,
            itemRenderer: _this3.props.itemRenderer,
            moveRow: _this3.props.moveRow,
            dropRow: _this3.onDropRow,
            dragBeginRow: _this3.onDragBeginRow,
            dragEndRow: _this3.onDragEndRow,
            findItemIndex: _this3.props.findItemIndex,
            canDropRow: _this3.props.canDropRow,
            measure: measure
          });
        }
      );
