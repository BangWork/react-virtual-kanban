...
var SortableList = function (_PureComponent) {
  ...
  function SortableList(props) {
    ...
    _this.onMoveRow = function (params) {
      return callWithListInfo(_this.props.moveRow, params, _this.props);
    };

    _this.onDropRow = function (params) {
      return callWithListInfo(_this.propsDropRow, params, _this.props);
    };
  ...
  (0, _createClass3.default)(SortableList, [{
    ...
    value: function render() {
      ...
      var listProps = {
        list: list, listId: listId, listStyle: listStyle, isDragging: isDragging, connectDragSource: connectDragSource, connectDropTarget: connectDropTarget,
        children: children
      };
