...
var SortableList = function (_PureComponent) {
  ...
  function SortableList(props) {
    ...
    _this.onMoveRow = function (from, to) {
      _this.props.moveRow(from, to);
      // this.measureCache.
    };
  ...
  (0, _createClass3.default)(SortableList, [{
    ...
    value: function render() {
      ...
      var listProps = {
        list: list, listId: listId, listStyle: listStyle, connectDragSource: connectDragSource, connectDropTarget: connectDropTarget,
