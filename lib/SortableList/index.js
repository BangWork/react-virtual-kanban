...
var SortableList = function (_PureComponent) {
  ...
  (0, _createClass3.default)(SortableList, [{
    ...
    value: function render() {
      ...
      var listProps = {
        list: list, listId: listId, listStyle: listStyle, isDragging: isDragging, isDraggingOver: isDraggingOver,
        connectDragSource: connectDragSource, connectDropTarget: connectDropTarget,
        children: children
      };
