  ...
  (0, _createClass3.default)(SortableItem, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          captureHeight = _props.captureHeight,
          index = _props.index;


      var itemProps = {
        row: row, rowId: rowId, fromListId: fromListId, listId: listId, rowStyle: rowStyle, isDragging: isDragging,
        connectDropTarget: connectDropTarget, connectDragSource: connectDragSource, connectDragPreview: connectDragPreview,
        measure: measure, captureHeight: captureHeight, index: index
      };
