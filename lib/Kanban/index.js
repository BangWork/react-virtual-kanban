...
var Kanban = function (_PureComponent) {
  ...
  (0, _createClass3.default)(Kanban, [{
    ...
    key: 'startScrollCheckTimer',
    value: function startScrollCheckTimer() {
      var _this2 = this;

      if (!this.scrollCheckTimerId) {
        this.scrollCheckTimerId = setInterval(function () {
          if (!_this2.hasScrollChanged) {
            _this2.endScrollCheckTimer();
            _this2.isScrolling = false;
          }
          _this2.hasScrollChanged = false;
        }, 500);
      }
    }
  }, {
    key: 'endScrollCheckTimer',
    value: function endScrollCheckTimer() {
      if (this.scrollCheckTimerId) {
    ...
    value: function onMoveList(from, to) {
      ...
      var newLists = (0, _updateLists.updateLists)(this.state.lists, { from: from, to: to });
    ...
    key: 'onScrollChange',
    value: function onScrollChange(scrollLeft) {
