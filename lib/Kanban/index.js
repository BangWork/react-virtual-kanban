...
var Kanban = function (_PureComponent) {
  ...
  function Kanban(props) {
    ...
    _this.listIdsWaitingToResetPosition = new _set2.default();
    _this.timerIdsOfWaitingReset = {};
    _this.listIdsMovedInLastCycle = new _set2.default();
    _this.lastMoveRowInfo = null;
    _this.listRefs = {};
  ...
  (0, _createClass3.default)(Kanban, [{
    ...
    key: 'delayResetListPosition',
    value: function delayResetListPosition(listIds) {
      var _this2 = this;

      if (listIds.length <= 0) return;

      listIds.forEach(function (id) {
        if (!_this2.listIdsWaitingToResetPosition.has(id)) {
          var timerId = setTimeout(function () {
            ...
            _this2.listIdsWaitingToResetPosition.delete(id);
            delete _this2.timerIdsOfWaitingReset[id];
          }, ResetDelayTime);
          _this2.timerIdsOfWaitingReset[id] = timerId;
        }
      });
    }
  }, {
    key: 'cancelRestListPosition',
    value: function cancelRestListPosition() {
      var _iteratorNormalCompletion = true;
      var _didIteratorError = false;
      var _iteratorError = undefined;

      try {
        for (var _iterator = (0, _getIterator3.default)(this.listIdsWaitingToResetPosition), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          var id = _step.value;

          var timerId = this.timerIdsOfWaitingReset[id];
          if (timerId) {
    ...
    value: function onMoveRow(from, to) {
      ...
      if ((0, _isEqualWith2.default)(moveInfo, this.lastMoveRowInfo)) {
        return;
      }
      this.scheduleUpdate(function (prevState) {
      ...
      this.lastMoveRowInfo = { from: from, to: to };
    }
  }, {
    key: 'onDropList',
    ...
    value: function onDragEndList(_ref7) {
      ...
      this.delayResetListPosition([].concat((0, _toConsumableArray3.default)(this.listIdsMovedInLastCycle)));
